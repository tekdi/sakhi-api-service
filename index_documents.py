...
def split_documents(documents: List[Document], chunk_size: int = 4000, chunk_overlap: int = 200) -> List[Document]:
    """Split documents.
    ...
    for document in documents:
        for chunk in text_splitter.split_text(document.text):
            ...
            splitted_docs.append(Document(page_content=chunk, metadata={
